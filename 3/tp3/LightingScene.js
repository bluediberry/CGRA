...
/*		// Scene elements
		...
		this.materialFloor.setShininess(2);
		...
		this.materialTableTop.setDiffuse(0.3, 0.1, 0, 1);
		...
		this.materialLamp.setAmbient(0.5, 0.5, 0.5, 1);
		this.materialLamp.setDiffuse(0.7, 0.7, 0, 1);
		this.materialLamp.setSpecular(0.2, 0.2, 0.2, 1);
		this.materialLamp.setShininess(5);
